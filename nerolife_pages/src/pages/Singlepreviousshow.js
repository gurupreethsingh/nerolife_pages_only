...
import "./Singlepreviousshow.css";

const Singlepreviousshow = () => {
  return (
    <div>
      <h1 className="text-center text-light pb-3 fw-bold">
        PREVIOUS EVENT GONE
      </h1>
      ...
      <div className="mt-5 mb-5 d-flex flex-wrap justify-content-evenly">
        ...
        <div className="eachevent border">
          ...
          <div className="d-flex justify-content-start text-light p-2">
            <h1>RESERVATION : </h1> <p>Some name </p>
          </div>

          <div className="d-flex justify-content-start text-light p-2">
            <h1>GUEST LIST : </h1> <p> 1 | 2 | 3 | 4 | 5+ </p>
          </div>
...
export default Singlepreviousshow;
